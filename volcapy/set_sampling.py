...
def uniform_size_uniform_sample(input_set, sample_size, min_size=1, max_size=None, fixed_node=None):
    ...
    sizes = np.random.randint(low=min_size, high=high_bound, size=sample_size)
