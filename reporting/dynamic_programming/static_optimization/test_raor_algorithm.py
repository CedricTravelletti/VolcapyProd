""" Test the Randomized Anytime Orienteering algorithm.
...
start = time.time()
design = raor_algorithm(accessibility_graph, budget, reward_fn, sampler, base_station_node)
end = time.time()
...
for i in range(100):
    print(i)
    design = sampler(accessibility_graph)
    print("Sampled size: {}".format(len(design)))
