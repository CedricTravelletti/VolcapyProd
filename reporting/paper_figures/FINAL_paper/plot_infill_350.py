...
if __name__ == "__main__":
    n_datapoints_4 = list(range(0, 1210, 10))
    n_datapoints_5 = list(range(0, 1330, 10))
    n_datapoints_6 = list(range(0, 1320, 10))
    n_datapoints_7 = list(range(0, 1320, 10))
    n_datapoints_8 = list(range(0, 1310, 10))
    ...
    sns.lineplot(data=df, x='n_datapoints', y='correct', hue='sample_nr',
            style='sample_nr',
            legend=True)
    plt.savefig("correct_evolution_INFILL_350", bbox_inches="tight", pad_inches=0.1, dpi=600)
    plt.show()
