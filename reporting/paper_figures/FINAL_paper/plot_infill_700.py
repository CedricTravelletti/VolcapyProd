...
if __name__ == "__main__":
    n_datapoints_4 = list(range(0, 1360, 10))
    n_datapoints_5 = list(range(0, 1780, 10))
    n_datapoints_6 = list(range(0, 1780, 10))
    n_datapoints_7 = list(range(0, 1780, 10))
    n_datapoints_8 = list(range(0, 1780, 10))
    ...
    sns.lineplot(data=df, x='n_datapoints', y='correct', hue='sample_nr',
            style='sample_nr',
            legend=True)
    plt.savefig("correct_evolution_INFILL_700", bbox_inches="tight", pad_inches=0.1, dpi=600)
    plt.show()
