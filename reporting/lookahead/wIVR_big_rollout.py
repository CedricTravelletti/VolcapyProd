""" Study the rollout wIVR strategy.
...
from volcapy.strategy.rollout_weighted_ivr import RolloutWIVRStrategy
...
base_folder = "/storage/homefs/ct19x463/lookahead_results/"


def main(sample_nr):
    # Create output directory.
    output_folder = os.path.join(base_folder,
            "wIVR_big_rollout/sample_{}".format(sample_nr))
    ...
    strategy = RolloutWIVRStrategy(updatable_gp, data_coords,
            F, data_feed,
