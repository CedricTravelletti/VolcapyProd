...
ONPRIOR: Do not use the conditioned data as ground truth, but the prior
instead, so we are in a well-specified situation.
...
ground_truth_folder = "/home/ubuntu/Dev/VolcapyProd/data/AISTATS_results_v2/"
output_folder = "/home/ubuntu/Dev/VolcapyProd/data/AISTATS_results_v2/"
...
def main(sample_nr):
    ...
    output_path = os.path.join(output_folder, "INFILL_results_onprior/sample_{}".format(sample_nr))
